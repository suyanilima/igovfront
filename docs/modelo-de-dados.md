# Modelo de dados — Igov Controle

## 1. Objetivo

Este documento descreve a proposta de persistência dos dados do Igov Controle em Oracle. O modelo foi elaborado a partir dos campos e regras existentes na aplicação web.

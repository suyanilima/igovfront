...
function selecionarModoCadastro(modo){
  ...
  if(baseLegal){
    baseLegal.required = normativo;
    if(semNormativo) baseLegal.value = 'Portaria';
  }

  if(baseLegalNumero){
    baseLegalNumero.required = normativo;
    if(semNormativo) baseLegalNumero.value = '';
  }
...
async function cadastrar(){
  ...
  document.getElementById('f-baselegal').value='Portaria';
